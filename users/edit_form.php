    ...
    <section class="bg-dark" style="height: 100vh">
      <div class="container py-5 h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col"> 
            <form action="/users/edit.php?id=<?=$user['id']?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-0 d-flex justify-content-around align-items-center">
                    <div class="col-xl-6">
                        <div class="card-body p-md-5 text-black">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="first_name" value="<?= $user['first_name']?>"/>
                                    <label class="form-label">Ім'я</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div data-mdb-input-init class="form-outline">
                                    <input type="text" class="form-control form-control-lg" name="last_name" value="<?= $user['last_name']?>"/>
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                <input type="tel" id="phone" name="phone" placeholder="+380 098-668-49-67"  pattern="^\+380\s\d{3}-\d{3}-\d{2}-\d{2}$" required value="<?= $user['phone'] ?>">
                            ...
                            <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
                                ...
                                <input class="form-check-input" type="radio" value="Жінка" name="gender" <?= ($user['gender'] == 'Жінка') ? 'checked' : '' ?>/>
                                <label class="form-check-label">Жінка</label>
                            </div>
        
                            <div class="form-check form-check-inline mb-0 me-4">
                                <input class="form-check-input" type="radio" value="Чоловік" name="gender" <?= ($user['gender'] == 'Чоловік') ? 'checked' : '' ?>/>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <option value="Київ" <?= ($user['city'] == 'Київ') ? 'selected' : '' ?>>Київ</option>
                            <option value="Дніпропетровськ" <?= ($user['city'] == 'Дніпропетровськ') ? 'selected' : '' ?>>Дніпропетровськ</option>
                            <option value="Кам'янське" <?= ($user['city'] == "Кам'янське") ? 'selected' : '' ?>>Кам'янське</option>
                            </select>
                        </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php else: ?>
                            <img id="profilePhoto" ref="profilePhoto" src="../img/users_photo/<?= $user['photo']?>" alt="Profile Photo" class="profile-photo">
                        <?php endif; ?>
